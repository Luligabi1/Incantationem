...
public class ModConfig {
    ...
    public static class Enchantments {
        ...
        @SerialEntry public Charmed charmed = new Charmed();
        @SerialEntry public Decay decay = new Decay();
        @SerialEntry public Deflection deflection = new Deflection();
        @SerialEntry public FuseShot fuseShot = new FuseShot();
        @SerialEntry public ForgingTouch forgingTouch = new ForgingTouch();
        @SerialEntry public LastStand lastStand = new LastStand();
        @SerialEntry public Magnetic magnetic = new Magnetic();
        @SerialEntry public ReapingRod reapingRod = new ReapingRod();
        @SerialEntry public Retreat retreat = new Retreat();
        @SerialEntry public Venomous venomous = new Venomous();
        @SerialEntry public WaterSlash waterSlash = new WaterSlash();
        ...
        public static class FuseShot {
            @SerialEntry public int maxLevel = 3;
            @SerialEntry public boolean availableRandomly = false;
            @SerialEntry public boolean availableForBookOffer = true;
    ...
    @SerialEntry public Curses curses = new Curses(); // TODO add availableRandomly options to all curses so they can be fully disabled (why is that not a thing in the first place???)
    public static class Curses {
        @SerialEntry public Recklessness recklessness = new Recklessness();
        @SerialEntry public Shrieking shrieking = new Shrieking();
        @SerialEntry public Thunder thunder = new Thunder();
        @SerialEntry public ToughLuck toughLuck = new ToughLuck();
